  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="relative z-10 bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 max-w-md w-full border border-white/20"
      >
          {/* Кнопка выхода */}
        ...
        <>
          ...
          >
            ...
            <motion.div 
              ...
              className="mt-4 flex items-center justify-center gap-2 bg-white/10 px-4 py-2 rounded-full inline-flex cursor-pointer"
            >
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 p-4 bg-gradient-to-r from-red-500/20 to-pink-500/20 border border-red-400/50 text-red-200 rounded-xl text-sm backdrop-blur-sm"
            >
              ⚠️ {error}
            </motion.div>
          )}
          ...
          <motion.button
            ...
            className="w-full mb-4 py-4 px-6 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white font-bold rounded-xl hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 transition-all shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 relative overflow-hidden group"
          >
          ...
          <motion.button
            ...
            className="w-full py-4 px-6 bg-gradient-to-r from-violet-500 via-purple-500 to-pink-500 text-white font-bold rounded-xl hover:from-violet-600 hover:via-purple-600 hover:to-pink-600 transition-all shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 relative overflow-hidden group"
          >
          ...
          <motion.div
            ...
            className="mt-6 p-5 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20"
          >
