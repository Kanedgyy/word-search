...
const COMMON_WORDS = [
  ...
  'БАЗАДАННЫХ', 'СЕРВЕР', 'КЛИЕНТ', 'АПИ', 'ИНТЕРФЕЙС',
  ...
  'ПОЛИЦЕЙСКИЙ', 'ПОЖАРНЫЙ', 'ВОЕННЫЙ', 'СЕЛЬ', 'ФЕРМЕР',
  
  // Города и страны
  'МОСКВА', 'ПИТЕР', 'КИЕВ', 'МИНСК', 'АЛМАТЫ',
  'РОССИЯ', 'УКРАИНА', 'БЕЛАРУСЬ', 'КАЗАХСТАН', 'ПОЛЬША',
  ...
  'ВЧЕРА', 'СЕГОДНЯ', 'ЗАВТРА', 'ПОНЕДЕЛЬНИК', 'ВОСКРЕСЕНЬЕ',
];
